...
/**
 * @author https://github.com/kuangcp on 2020-05-04 22:18
 */
@SupportedAnnotationTypes("com.github.kuangcp.Getter")
...
public class GetterProcessor extends AbstractProcessor {
            ...
            tree.accept(new TreeTranslator() {
                ...
                public void visitClassDef(JCTree.JCClassDecl jcClassDecl) {
                    ...
                    jcVariableDeclList.forEach(jcVariableDecl -> {
                        ...
                        jcClassDecl.defs = jcClassDecl.defs.prepend(makeGetterMethodDeclare(jcVariableDecl));
                    });
    ...
    private JCTree.JCMethodDecl makeGetterMethodDeclare(JCTree.JCVariableDecl jcVariableDecl) {
    ...
    private Name getNewMethodName(Name name) {
        ...
        return names
                .fromString("get" + s.substring(0, 1).toUpperCase() + s.substring(1, name.length()));
    }
